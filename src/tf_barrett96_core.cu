...
Precalculated here since it is the same for all steps in the following loop */
  ...
  a.d1 = __subc_cc(b.d1, tmp96.d1);			// we do not need the upper digits of b and tmp96 because
  a.d2 = __subc   (b.d2, tmp96.d2);         // the result is 0 after subtraction!
    // clang-format on
  ...
  a.d2 = __subc   (b.d2, tmp96.d2);
    ...
    a.d2 = __subc   (b.d2, tmp96.d2);
        ...
        if (shifter & 0x80000000)
            shl_96(&a); // "optional multiply by 2" as in Prime95 documentation
...
Precalculated here since it is the same for all steps in the following loop */
  ...
  tmp96.d2 = __subc   (b.d2, tmp96.d2);
    ...
    tmp96.d2 = __subc   (b.d2, tmp96.d2);
        ...
        if (shifter & 0x80000000)
            shl_96(&tmp96); // "optional multiply by 2" as in Prime95 documentation
